CREATE DATABASE  IF NOT EXISTS `backend_2021` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `backend_2021`;
...
CREATE TABLE `schedules` (
  ...
  CONSTRAINT `fk_time_id` FOREIGN KEY (`time_id`) REFERENCES `show_times` (`id`)
...
INSERT INTO `schedules` VALUES (1,1,2,3),(2,1,2,2),(3,1,1,5),(4,1,2,1),(5,1,2,5),(6,1,2,6),(7,1,3,1),(8,1,3,2),(9,1,3,3),(10,2,2,2),(11,2,2,4),(12,2,2,6),(13,3,1,3),(14,3,3,5),(15,3,3,6),(16,4,1,1),(17,4,2,2),(18,4,2,4),(19,4,3,3),(20,5,1,5),(21,5,2,5),(22,5,3,5),(23,6,1,1),(24,6,2,2),(25,6,3,3),(26,8,1,4),(27,8,1,6),(28,9,1,1),(29,9,1,2),(31,9,1,3);
...
INSERT INTO `users` VALUES (1,'1612336843636','test123','test@te.st','test1!',2,3,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3QxMjMiLCJpYXQiOjE2MTIzMzY4NDN9.qDt17RZqpHvXwq-wKKBIRZ4buf1dsnG4dEKslwdHuhU'),(2,'1612336927387','test223','test@te.st','test1!',2,1,'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InRlc3QyMjMiLCJpYXQiOjE2MTIzMzY5Mjd9.EHkoaclXX5i6TQReJK5HF09QYH3zpqy5LYvdzG0YAfg');
...
-- Dump completed on 2021-02-03 16:45:55
